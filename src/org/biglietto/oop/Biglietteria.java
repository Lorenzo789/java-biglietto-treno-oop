...
//	assicurandosi che abbiano valori validi
//	(creare due metodi *isValidKm* e *isValidEta*
//	che implementano questa logica). In caso anche
...
//
//	Implementare il metodo public che calcola il prezzo del biglietto
//	comprensivo di eventuale
//	sconto (*calcolaPrezzo*). Per eseguire il calcolo dello sconto aggiungere
//	un metodo private
...
//	- con quei dati provare a creare un nuovo Biglietto
//	(gestire eventuali eccezioni con try-catch)
...
//	che calcola la data di scadenza
//	del biglietto, applicando la durata normale o flessibile
...
//
//	Modificare la classe Biglietteria in modo che,
//	alla creazione del Biglietto, valorizzi la data con
//	la data odierna e il parametro flessibile in base alla scelta dell’utente.
//	Dopo aver stampato il prezzo del biglietto, stampare a video
//	anche la data di scadenza.
//
//	*NOTA*: per aggiungere dei giorni a un oggetto di tipo LocalDate,
//	si può usare il metodo *plusDays* (vedi esempio)
//
//	##### MILESTONE 4 (BONUS)
